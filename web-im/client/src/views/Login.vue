<template>
	<div class="login-wrapper" :style="'background-image:url(/static/img/login-background.jpg)'">
		<div class="form-box">
			<div class="form-title">
				<img :src="globalConfig.sysInfo.logo ? globalConfig.sysInfo.logo : $packageData.logo" width="100"
					alt="icon">
			</div>
			<el-form ref="loginForm" :model="loginForm" :rules="loginRules" label-width="0px" class="login-form">
				...
				<el-form-item prop="code" v-show="forget">
					<el-input placeholder="请输入验证码" maxlength="6" v-model="loginForm.code">
